...
return (
    <div className="min-h-screen w-full flex flex-col items-center py-16 px-4 selection:bg-indigo-100" 
         style={{ 
      ...
      <div className="w-full max-w-3xl">
        <header className="relative mb-14 group">
          ...
          <div className="relative backdrop-blur-xl bg-white/40 p-10 rounded-3xl border border-white/60 shadow-2xl">
            <h2 className="font-black text-5xl tracking-tight leading-tight" style={{ color: "#1F5669" }}>
              Recommended <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-600">Jobs</span>
            </h2>
              ...
              <div className="bg-white/90 p-8 rounded-[2.3rem]">
                ...
                <div className="mt-8 pt-6 border-t border-slate-50 flex items-center justify-between">
                  <div className="flex -space-x-2">
                    ...
                    <span className="pl-4 text-[11px] text-slate-400 font-bold self-center">12 others applied</span>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <button className="px-8 py-3 bg-[#1F5669] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-[0_10px_20px_rgba(31,86,105,0.2)] hover:bg-blue-700 hover:shadow-blue-500/30 transition-all active:scale-95"
                    onClick={() => router.push(`/apply?jobTitle=${encodeURIComponent(job.title)}&company=${encodeURIComponent(job.company)}`)}>
                      Apply Now
                    </button>
                  </div>
                </div>
