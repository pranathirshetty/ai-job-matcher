            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                {[
                  ...
                  { placeholder: "Years of Experience", setter: setYears, type: "number" },
                  { placeholder: "Domain", setter: setDomain, type: "text" },
                  { placeholder: "Location", setter: setLocation, type: "text" },
                  { placeholder: "Expected Salary", setter: setSalary, type: "text" },
                ].map((input, idx) => (
              ...
              <button disabled={saving}
                ...
                className="group relative w-full overflow-hidden rounded-2xl bg-[#185D72] p-5 font-black text-white shadow-xl transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:hover:scale-100" >
                ...
                <span className="relative flex items-center justify-center gap-2 tracking-widest uppercase text-xs">
                  {saving ? (  <>
                      <div className="h-4 w-4 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>  Encrypting Data...</>  ) : (   "Initialize AI Profile")}
                </span> </button> 
            </div>
          </div>
        </div>
