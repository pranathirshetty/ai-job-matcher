...
">
        ...
        <p className="py-2 text-[18px] text-gray-600">
          ...
          Find opportunities tailored to your skills, interest,and search
          history
        </p>
...
>
  Search using AI
      ...
      <div className=" flex items-center justify-center py-3">Based on your profile and recent activity </div>
